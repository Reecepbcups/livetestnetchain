...
HTTPS_GIT := github.com/rollchains/livetestnetchain.git
...
ldflags = -X github.com/cosmos/cosmos-sdk/version.Name=livetestnetchain \
...
ifeq (,$(shell which heighliner))
	...
	heighliner build -c livetestnetchain --local -f chains.yaml
endif
...
set-testnet-configs:
	simd config set client chain-id chainid-1
