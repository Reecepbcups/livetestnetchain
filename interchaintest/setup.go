...
var (
	...
	ChainImage = ibc.NewDockerImage("livetestnetchain", "local", "1025:1025")
	...
	DefaultGenesis = []cosmos.GenesisKV{
		...
		cosmos.NewGenesisKV("app_state.poa.params.admins", []string{"cosmos10d07y265gmmuvt4z0w9aw880jnsr700j6zn9kn", "cosmos1hj5fveer5cjtn4wd6wstzugjfdxzl0xpxvjjvr"}),
